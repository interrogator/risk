...
\noindent Findings are organised according to the formulation of areas of interest as questions. These questions progress from general frequency counting (Q1), through experiential meanings (Qs 2--7), to risk as modifier (Qs 8 \& 9) and finally to arguability (Q10). Discussion of the general significance of individual findings is also presented in this section, as the Discussion section synergises all findings to explain the discourse-semantics of risk.
  ...
  \parbox{1\textwidth}{%
  \textsc{\textbf{Note:}} Summarised versionf for each main question will be presented in highlighted text boxes of this form.}}
...
\FloatBarrier
    ...
    1963 is excluded from analysis here, as poor quality OCR created a number of non-word results\endnote{Poor quality OCR caused single occurrences of tokens such as \emph{risks-wnrk}, \emph{risks.North} and \emph{risks.With} to appear in 1963}.
  ...
  \textsc{\textbf{Finding 2:}} Risk as a process is declining in use, and has been overtaken in frequency by risk as a participant.}}
    ...
    \end{table}
      ...
      \noindent\colorbox{yellow!20}{%
  \parbox{1\textwidth}{%
  \textsc{\textbf{Finding 3:}} Risk is more often an experiential object than an experiential subject. The gap has widened considerably over time.}}
