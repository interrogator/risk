...
\FloatBarrier
	...
	The first point of interest was the overall frequency of risk words in the NYT and the distribution of risk words by word class (nominal, verbal, adjectival\slash adverbial), absent any consideration of surrounding grammar (see Figure \ref{fig:wordclasses}). We found a trend toward nominal forms, with the other categories remaining more or less stable. %Using our reference corpus, we checked to see whether nominals were becoming more frequent within the NYT more generally.
