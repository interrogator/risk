...
If contestation of science and research happens mostly within certain communicative genres (e.g. casual conversation, Tweets, etc.) or among certain demographics, it seems prudent to suggest further research focussing on the presentation of science within different kinds of talk. This could be useful in building an empirically driven account of the genesis, mechanism and effects of contestation of mainstream science and research.
    ...
    %Ultimately, the ways in which a corpus can be analysed are dependent on the size of the corpus. Larger corpora are more amenable to very specific kinds of lexicogrammatical querying, whereas smaller corpora may need to be analysed using more general or traditional approaches, such as n-grams and keywords.
...
~\ \todo[inline,color=green!40]{\noindent Discussion to be furthered by Jens?}
...
That said, categorisation of abstracted data is difficult, and prone to error, particularly in the case of keywords. %The keywording in particular revealed a number of ambiguities. A more reliable\slash systematic method for grouping keywords would ameliorate this concern.
