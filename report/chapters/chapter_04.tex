...
\section{Which experiential roles do risk words occupy?} \label{sect:exprole} \FloatBarrier
    ...
    \begin{tabular}{lll}
    \toprule
    \textbf{Example}       & \textbf{Word class}     & \textbf{Experiential role}     \\ \midrule
    \emph{It was risky}  & Adjective  &  Participant   \\ 
    \emph{A risking of lives} & Noun  &  Nominalised process   \\ 
    \emph{Risk management}  & Noun & Modifier   \\ \bottomrule
    \end{tabular}
...
\section{Is risk more commonly in the position of experiential subject or experiential object?} \FloatBarrier
    ...
    \centering
    \addvbuffer[12pt 8pt]{\begin{tabularx}{0.75\textwidth}{XX}
    \toprule
    \textbf{As subject} & \textbf{As object} \\ \midrule
    1. \texttt{But the most prevalent \textbf{risk} for the average traveler to Peru is the high altitude of the Andes}   & 1. \texttt{The company has resolved accounting problems, he said, and stabilized profit margins, while new management has reduced the company's \textbf{risks}}  \\ 
    2. \texttt{The \textbf{risk} would be that the stock would recover during the period that the investor was out of the stock}   & 2. \texttt{But an empty village is a big \textbf{risk}.}  \\ 
    3. \texttt{But the \textbf{risk}, though very small, that a man facing execution could win a new trial raises the question why this rule has proved so hard to follow}   & 3. \texttt{They said there was only a little \textbf{risk}, and now he 's not with us anymore} \\ \bottomrule
    \end{tabularx}}
...
\section{What processes are involved when risk is a participant?} \FloatBarrier
    ...
    \small
    \begin{tabularx}{1.0\textwidth}{>{\raggedright}Xl}
    \toprule
    \textbf{Processes when risk is experiential subject} & \textbf{Total} \\ \midrule
    be                                      & 8954  \\ 
    increase                                & 460   \\ 
    outweigh                                & 278   \\ 
    rise                                    & 269   \\ 
    ...
    \begin{tabularx}{1.0\textwidth}{>{\raggedright}Xl}
    \toprule
    \textbf{Processes when risk is experiential object} & \textbf{Total} \\ \midrule
    %take                                             & 11459 \\ 
    reduce                                           & 5609  \\ 
    pose                                             & 4179  \\ 
    increase                                         & 4063  \\ 
...
\section{How are participant risks modified?} \label{sect:highpotential} \FloatBarrier
    ...
    \begin{tabular}{ll}
    \toprule
    \textbf{Pre-head modifier}     & \textbf{Total} \\ \midrule
    high         & 4753  \\ 
    great        & 3444  \\ 
    big          & 1672  \\ 
    political    & 1520  \\ 
    ...
    \begin{tabular}{ll}
    \toprule
    \textbf{Post-head modifier} & \textbf{Total} \\ \midrule
    cancer             & 2344  \\ 
    disease            & 1777  \\ 
    attack             & 1597  \\ 
    death              & 1025  \\ 
...
\section{When risk is a process, what participants are involved?} \FloatBarrier
    ...
    \centering
    \small
    \begin{tabularx}{1.0\textwidth}{>{\raggedright}lX}
    \toprule
    \textbf{Risker}           & \textbf{Risked thing\slash potential harm} \\ \midrule
    person & life \\ 
    company & injury \\ 
    state & loss \\ 
    woman & everything \\ 
    ...
    move & job \\ 
    firm & backlash \\ 
    administration & failure \\ \bottomrule
    \end{tabularx}
    ...
    \toprule
    \textbf{Embedded process}      & \textbf{Total ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~} \\ \midrule
    lose      & 1260  \\ 
    be        & 1095  \\ 
    alienate  & 379   \\ 
    have      & 347   \\ 
...
\section{When risk is a modifier, what are the most common forms?} \label{sect:mod_one} \FloatBarrier
    ...
    \begin{tabular}{ll}
    \toprule
    \textbf{Modifier type}       & \textbf{Example}          \\ \midrule
    Adjectival pre-head & \emph{a risky move}     \\ 
    Post-head           & \emph{A person at risk} \\ 
    pre-head nominal    & \emph{risk management}  \\ 
    Adverbial           & \emph{to riskily act}   \\ 
    Circumstance head   & \emph{to be at risk }   \\ \bottomrule
    \end{tabular}
...
\section{When risk is a modifier, what is being modified?} \label{sect:mod_two} \FloatBarrier 
    ...
    \toprule
    \textbf{Risk-modified \mbox{participant}}        & \textbf{Total} \\ \midrule
    investment  & 696   \\ 
    business    & 515   \\ 
    behavior    & 508   \\ 
    group       & 466   \\ 
    ...
    \begin{tabularx}{1.0\textwidth}{Xl}
    \toprule
    \textbf{At-risk \mbox{participant}}       & \textbf{Total} \\ \midrule
    person     & 439   \\ 
    child      & 368   \\ 
    woman      & 209   \\ 
    student    & 179   \\ 
