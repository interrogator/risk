...
1. \texttt{But the most prevalent \textbf{risk} for the average traveler to Peru is the high altitude of the Andes}   & 1. \texttt{They said there was only a little \textbf{risk}, and now he 's not with us anymore} \\ 
...
3. \texttt{But the \textbf{risk}, though very small, that a man facing execution could win a new trial raises the question why this rule has proved so hard to follow}   & 3. \texttt{The company has resolved accounting problems, he said, and stabilized profit margins, while new management has reduced the company's \textbf{risks}}  \\ \bottomrule
\end{tabularx}}
...
0    & Doctors who use the word `obese' in their notes may \textbf{risk} alienating patients.   \\ 
...
1    & But Latino political leaders say the \textbf{risk} in changing the questions could create confusion and lead some Latinos not to mark their ethnicity, shrinking the overall Hispanic numbers. \\ 
