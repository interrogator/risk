...
\include{chapters/chapter_02} % Case study

\include{chapters/chapter_03} % Methodology

\include{chapters/chapter_04} % Findings: annual

\include{chapters/chapter_05} % Findings: health corpus

\include{chapters/chapter_06} % Discourse semantics in NYT

\include{chapters/chapter_07} % Limitations, research agenda, conclusions
